    ...
    <>
      <div className='plcard__autor'>
        <div
          ...
          alt='user'
        ></div>
        <p className='plcard__autor--job'>{eachLi.job || 'Full Stack Developer'}</p>
        <p className='plcard__autor--name'>{eachLi.autor || 'Emmelie Björklund'}</p>
      </div>
      <div className='plcard__infoProject'>
        <p className='plcard__infoProject--subtitle'>Proyecto para Townsville</p>
        <hr className='line' />
        <h2 className='plcard__infoProject--title'>{eachLi.name || 'Elegant Workspace'}</h2>
        <p className='plcard__infoProject--slogan'>{eachLi.slogan || 'Diseños Exclusivos'}</p>
        ...
        <div className='plcard__technologies'>
          <p className='plcard__technologies--text'>{eachLi.type || 'Infraestructura'}</p>
          <p className='card__technologies--text'>{'$ ' + eachLi.budget || '$9999'}</p>
          <div className='plcard__technologies--icons'>
            <a href={eachLi.link} className='icons__link' target='_blank' rel='noreferrer'>
